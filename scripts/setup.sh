...
OPENAI_API_KEY=$OPENAI_API_KEY DEEPSEEK_API_KEY=$DEEPSEEK_API_KEY ALIBABA_API_KEY=$ALIBABA_API_KEY CODE=$CODE PORT=$PORT yarn build
OPENAI_API_KEY=$OPENAI_API_KEY DEEPSEEK_API_KEY=$DEEPSEEK_API_KEY ALIBABA_API_KEY=$ALIBABA_API_KEY CODE=$CODE PORT=$PORT yarn start
